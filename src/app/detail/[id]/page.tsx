...
const Page = ({ params }: { params: { id: string } }) => {
  const id = params.id;
  return (
    <main className="px-5 py-8 pt-28 lg:pt-24 lg:p-16 flex flex-col min-h-screen justify-start items-start text-VeryDarkBlueLM bg-VeryLightGrayLM dark:bg-VeryDarkBlueDM dark:text-White">
